...
([Piper](https://github.com/rhasspy/piper) voice, ~64MB, cached after). Fully
offline, on-device, **no server to run yourself**. Pick the **voice (8 US/UK
options)** and **speed (0.5–2×)** in ⚙.
